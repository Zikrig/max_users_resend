...
DELEGATES_MENU = (
    "Это админское меню. Здесь вы можете добавить аккаунты, которые смогут управлять вашими каналами. Для этого понадобится их id - каждый пользователь Max может узнать его в боте @userinfobot\n"
...
CHANNELS_HEADER = "Подключённые каналы (канал → чат комментариев).\nВ этом меню вы можете дообавлять новые каналы, а также управлять Mute-режимом и редактировать посты"
