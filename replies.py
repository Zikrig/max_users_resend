...
BTN_BACK = "Назад"
# Подпись кнопки отмены ввода и одна фраза при отмене (везде одинаково).
BTN_CANCEL = "Отмена"
MSG_PROMPT_CANCELLED = "Ввод отменён."
BTN_ADD_CHANNEL = "Добавить канал"
BTN_ADD_DELEGATE = "Добавить админа"
BTN_ADD_MASTER = "Добавить мастера"
BTN_CHANGE_TEXT = "Изменить текст"
BTN_CHANGE_LINK = "Изменить ссылку"
BTN_CHANGE_BUTTON = "Изменить кнопку"
BTN_TOGGLE_ON = "Включить"
BTN_TOGGLE_OFF = "Выключить"
BTN_MUTE = "Mute"
BTN_POSTS = "Посты"
BTN_DELETE = "Удалить"
...
INSTRUCTION_TEXT_CHANGED = "Текст инструкции изменен."
INSTRUCTION_BUTTON_TEXT_CHANGED = "Текст кнопки инструкции изменен: {text}"
INSTRUCTION_VISIBILITY_CHANGED = "Показ инструкции в пользовательском меню: {state}"
...
PROMPT_INSTRUCTION_TEXT = (
    ...
    "Поддерживается текущая разметка сообщения (markdown/html и spans)."
)
PROMPT_INSTRUCTION_BUTTON_TEXT = "Введите новый текст кнопки инструкции:"
...
DELEGATE_NO_MASTER = "Нельзя добавить мастер-админа как админа аккаунта."
DELEGATE_ALREADY_IN_TREE = "Этот пользователь уже в дереве админов (только один «спонсор»)."
DELEGATE_HAS_OWN_ACCOUNT = "У этого пользователя уже есть свои каналы (отдельный аккаунт)."
DELEGATE_ADDED = "Админ добавлен: {uid}"
DELEGATE_REMOVED = "Админ удалён: {uid}"
DELEGATE_REMOVE_NOT_YOURS = "Можно удалять только своих прямых админов."
PROMPT_DELEGATE_ID = "Введите user_id нового админа:"

DELEGATES_MENU = (
    "Это админское меню. Здесь вы можете добавить аккаунты, которые смогут управлять вашим ботом. Для этого понадобится их id - каждый пользователь Max может узнать его в боте @userinfobot\n"
    "Админы видят только каналы, которые добавили вы, и наследованные от вас по правилам бота.\n"
    "Текущие: {list_text}"
)
...
CHANNELS_HEADER = "Подключённые каналы (канал → чат комментариев).\nВ этом меню вы можете добавлять новые каналы, а также управлять Mute-режимом и редактировать посты"
CHANNELS_DELEGATED_HINT = "Вот такой символ: {emoji} — означает, что канал добавлен не вами (наследован от вышестоящего админа)."
...
MASTER_INSTRUCTION_SUBMENU = (
    "Инструкция в пользовательском меню.\n"
    "Кнопка в меню: {button_text}\n"
    "Показывать в пользовательском меню: {enabled}\n\n"
    "Текущий текст инструкции:\n"
    "{instruction_text}"
)

INSTRUCTION_EMPTY_PLACEHOLDER = "— пока не задан —"
INSTRUCTION_VISIBLE_YES = "да"
INSTRUCTION_VISIBLE_NO = "нет"
